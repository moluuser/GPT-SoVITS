...
p_train_SoVITS=None
def open1Ba(batch_size,total_epoch,exp_name,text_low_lr_rate,if_save_latest,if_save_every_weights,save_every_epoch,gpu_numbers1Ba,pretrained_s2G,pretrained_s2D,output_dir):
    ...
    if(p_train_SoVITS==None):
        ...
        data["save_weight_dir"]=output_dir
        data["name"]=exp_name
...
p_train_GPT=None
def open1Bb(batch_size,total_epoch,exp_name,if_dpo,if_save_latest,if_save_every_weights,save_every_epoch,gpu_numbers,pretrained_s1,output_dir):
    os.makedirs(output_dir,exist_ok=True)
    global p_train_GPT
    if(p_train_GPT==None):
        ...
        data["train"]["half_weights_save_dir"]=output_dir
